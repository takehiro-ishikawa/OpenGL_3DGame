...
void InputSystem::SetUpInputMap()
{
	// 軸入力
	mState.SetAxisMap(INPUT_LEFT_AXIS, SDL_SCANCODE_W, SDL_SCANCODE_S, SDL_SCANCODE_D, SDL_SCANCODE_A,
		false, false);
	mState.SetAxisMap(INPUT_RIGHT_AXIS, SDL_SCANCODE_DOWN, SDL_SCANCODE_UP, SDL_SCANCODE_RIGHT, SDL_SCANCODE_LEFT,
		true, true);

	// キー入力
	mState.SetInputMap(INPUT_JUMP, SDL_SCANCODE_SPACE, 0, SDL_CONTROLLER_BUTTON_A);
	mState.SetInputMap(INPUT_UP, SDL_SCANCODE_E, 0, SDL_CONTROLLER_BUTTON_B);
	mState.SetInputMap(INPUT_DOWN, SDL_SCANCODE_Q, 0, SDL_CONTROLLER_BUTTON_X);
	mState.SetInputMap(INPUT_FIRE, SDL_SCANCODE_C, SDL_BUTTON_LEFT, SDL_CONTROLLER_BUTTON_RIGHTSHOULDER);
	mState.SetInputMap(INPUT_FIRE_STANDBY, SDL_SCANCODE_Z, SDL_BUTTON_RIGHT, SDL_CONTROLLER_BUTTON_LEFTSHOULDER);
	mState.SetInputMap(INPUT_ATTACK, SDL_SCANCODE_F, 0, SDL_CONTROLLER_BUTTON_RIGHTSTICK);
	mState.SetInputMap(INPUT_SPRINT, SDL_SCANCODE_LSHIFT, 0, SDL_CONTROLLER_BUTTON_LEFTSTICK);
	mState.SetInputMap(INPUT_OK, SDL_SCANCODE_O, SDL_BUTTON_LEFT, SDL_CONTROLLER_BUTTON_A);
	mState.SetInputMap(INPUT_MENU, SDL_SCANCODE_ESCAPE, 0, SDL_CONTROLLER_BUTTON_START);
}
