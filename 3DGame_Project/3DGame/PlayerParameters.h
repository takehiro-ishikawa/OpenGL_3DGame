...
#define PLAYER_ANIMATION_IDLE       "Idle"              // プレイヤーの"待機"アニメーション名
#define PLAYER_ANIMATION_WALK       "Walk"              // プレイヤーの"歩行"アニメーション名
#define PLAYER_ANIMATION_RUN        "Run"               // プレイヤーの"ダッシュ"アニメーション名
#define PLAYER_ANIMATION_SHOOT      "Shoot"             // プレイヤーの"射撃"アニメーション名
#define PLAYER_ANIMATION_SHOOT_WALK "ShootAndWalk"      // プレイヤーの"射撃&歩行"アニメーション名
